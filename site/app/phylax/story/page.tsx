...
export const metadata: Metadata = {
  title: "PHYLAX Story Archive | The First Breach",
  description:
    "The story archive for PHYLAX: The First Breach — a dark cinematic album world about watching, longing, oath, descent, forbidden knowledge, consequence, and memory.",
};
