...
export const storyAssets = {
  ...
  "field-notes": {
    ...
    caption: "Editorial field-notes image for the forthcoming companion-book archive.",
    routeTargets: ["/book"],
    chapterCue: "Companion-book work in progress",
    isDecorative: false,
    priority: "supporting",
    placement: ["book hero", "home book feature"],
    status: "active",
