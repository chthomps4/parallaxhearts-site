...
export const metadata: Metadata = {
  ...
  description:
    "Listen to What the Town Keeps by Parallax Hearts — a cinematic acoustic alternative album tied to Vallen, the visual novel archive, and the wider story world.",
};
